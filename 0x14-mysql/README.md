...
primary-replica model. I configured both servers.
...
`my.conf` configuration file used to set up my first server web-01 as a primary database
server on the database `tyrell_corp`.

* [4-mysql_configuration_replica](./4-mysql_configuration_replica): The MySQL
`my.conf` configuration file used to set up my second server web-02 as the replica
